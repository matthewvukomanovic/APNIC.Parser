    ...
    public class CommandLineOptions
    {
        ...
        public bool TryParse(IEnumerable<string> args)
        {
            try
            {
                ...
                //if (NoClipboardSet && NoConsolePrint && OutputFile == null && (!DownloadFile || NeverDownloadFile))
                //{
                //    ParseMessage = ""; // No message since the arguments asked for it.
                //    return false;
                //}
        ...
        private OptionSet GetOptionSet()
        {
            var options = new OptionSet {
                ...
                { "l|location=", "a location to limit the details to", n => LimitLocations.Add(n) },
                { "t|type=", "a type to limit the details to", n => LimitTypes.Add(n) },
                ...
                //{ "c", "show just the country information", o => ShowOnlyCountry = o},
                { "L|no-location-limit", "no limit on the location", o => NoLocationLimit = o != null},
                { "T|no-type-limit", "no limit on the location", o => NoTypeLimit = o != null},
                ...
                //{ "d", "Download the file even if not processing file", o => DownloadFile = o != null},
                //{ "D", "Never download the file", o => NeverDownloadFile = o != null},
                //{ "w|cache-file", "set the name of the cache file", o => CacheFileName = o},
        ...
        //public bool NeverDownloadFile { get; set; }
